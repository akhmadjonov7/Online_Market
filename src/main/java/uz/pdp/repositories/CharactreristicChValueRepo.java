...
public interface CharactreristicChValueRepo extends JpaRepository<CharacteristicsChValues,Integer> {
        ...
        @Query(nativeQuery = true, value = "select id from characteristics_ch_values where characteristic_id = :id and  characteristic_value_id = :id1")
     Integer getCharacteristicId(int id, int id1);
